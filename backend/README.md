...
## Project Structure
    ...
    ├── young_waterfall_29324  # Django project configurations
...
1. Clone this repo and `cd young_waterfall_29324`
...
2. Clone this repo and `cd young_waterfall_29324`
